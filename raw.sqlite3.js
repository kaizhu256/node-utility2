...
shRawLibFetch
{
    "fetchList": [
        {
            "sh": "for PLATFORM in darwin linux win32\ndo\n    for ARCH in x64\n    do\n        FILE=\"napi-v3-$PLATFORM-$ARCH\"\n        curl -A \"chrome\" \"https://mapbox-node-binary.s3.amazonaws.com/sqlite3/v5.0.0/$FILE.tar.gz\" | tar -O -xz \"$FILE/node_sqlite3.node\" > \".node_sqlite3-v5.0.0-$FILE.node\"\n    done\ndone\n",
