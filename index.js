...
(function () {
  ...
  $$local = {
    _init: function () {
      /*
        this function inits this app
      */
      // init mainApp.modeJs
      mainApp = { modeJs: 'undefined' };
      try {
        // check phantom js env
        mainApp.modeJs = window && phantom.version &&
          typeof phantom.injectJs === 'function' && 'phantom';
      } catch (errorCaughtPhantom) {
        try {
          // check node js env
          mainApp.modeJs = global && process.versions.node &&
            typeof process.cwd === 'function' && 'node';
        } catch (errorCaughtNode) {
          try {
            // check browser js env
            mainApp.modeJs = window && navigator.userAgent &&
              typeof document.getElementById === 'function' && 'browser';
          } catch (ignore) {
          }
        }
      }
      ...
      case 'browser':
        // init mainApp
        mainApp = window.$$mainApp = window.$$mainApp || mainApp;
        mainApp.modeJs = 'browser';
        $$local._initShared(window);
      ...
      case 'node':
        ...
        mainApp._PACKAGE_JSON_NAME = process.env.PACKAGE_JSON_NAME;
        $$local._initShared(global);
        $$local._initNode(global);
        break;
      // init phantom js env
      case 'phantom':
        $$local._initShared(window);
        $$local._initPhantom(window);
        break;
      }
    },
    ...
    _initBrowser: function (global) {
      /*
        this browser module exports useful utilities
      */
      var local;
      local = {
    ...
    _initNode: function (global) {
      /*
        this node module exports useful utilities
      */
      var local;
      local = {
        _name: 'utility2.node',
        ...
        _init: function () {
          ...
          */
          ...
          mainApp.setDefault(mainApp, -1, {
            // init coverage-mode
            __coverage__: process.env.npm_config_mode_coverage && {},
            // export __dirname
            __dirname: __dirname,
            // init state file used for browser init
            _mainAppBrowser: {
              // export package.json name
              _PACKAGE_JSON_NAME: mainApp._PACKAGE_JSON_NAME,
              _fileCacheDict: {}
            }
          });
          // cache index.* files
        ...
        testPhantom: function (url, onError) {
          ...
          */
          ...
          ['phantomjs', 'slimerjs'].forEach(function (argv0) {
            ...
            file = __dirname + '/index.js';
            // cover index.js
            if (local.__coverage__ && 'utility2' === mainApp._PACKAGE_JSON_NAME) {
    ...
    _initPhantom: function (global) {
      /*
        this phantom module exports useful utilities
      */
      var local;
      local = {
    ...
    _initShared: function (global) {
      /*
        this shared module exports useful utilities
      */
      var local;
      local = {
        _name: 'utility2.shared',
        ...
        _init: function () {
          ...
          */
          ...
          mainApp.setDefault(mainApp, -1, {
            ...
            _fileCacheDict: {},
            // init mime-type lookup for file extensions
            _mimeLookupDict: {
        ...
        testMerge: function (testReport1, testReport2) {
          ...
          */
          var errorStackList, env, testCaseNumber, testReport, text;
          ...
          */
          ...
          testPlatform.testCaseList.map(function (testCase) {
            ...
            onError = function (error) {
              ...
              if (testCase.name === 'utility2.shared.__testRun_failedTest_test') {
