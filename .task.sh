...
LIST="
npmdoc/node-npmdoc-cordova-plugin-file
npmdoc/node-npmdoc-cordova-plugin-file-transfer
npmdoc/node-npmdoc-cordova-plugin-globalization
npmdoc/node-npmdoc-cordova-plugin-imagepicker
npmdoc/node-npmdoc-cordova-plugin-media-capture
npmdoc/node-npmdoc-cordova-plugin-network-information
npmdoc/node-npmdoc-cordova.plugins.diagnostic
npmdoc/node-npmdoc-cordova-plugin-splashscreen
npmdoc/node-npmdoc-cordova-plugin-statusbar
npmdoc/node-npmdoc-cordova-plugin-whitelist
npmdoc/node-npmdoc-cordova-sqlite-storage
"
