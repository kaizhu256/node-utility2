...
for (i in globalThis['SQL']) {
  Module[i] = globalThis['SQL'][i];
}
...
local.sqljsTableImport = async function (opt) {
/*
...
if (!local.isBrowser) {
    module.exports = Object.assign(local, module.exports);
}
}());
}());
